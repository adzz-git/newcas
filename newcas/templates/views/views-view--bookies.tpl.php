<div id="bookies_grid">
  <div class="row justify-content-center">
    <?php
      ...
      ?>
      <div class="col-md-auto flex-5 flex-grow-1 mb-3 mb-md-0">
        <div class="bg-white shadow-sm rounded over-hidden">
          <div style="background: #<?php print $hexa; ?>" class="const-height-a position-relative">
            ...
            <div class="row justify-content-center h-100">
              <div class="col-11 col-sm-8 col-md-4 align-self-center text-md-center">
          ...
          <div class="p-2 text-md-center mt-md-2">
            ...
            <div class="mt-md-2">
              ...
              <div class="d-inline-block font-xs text-black-50 align-middle">
                (<?php print $rating; ?>/10)
              </div>
            </div>
            <!-- Bonuses -->

<?php if(!empty($writer)): ?>
	<?php include_once('inc/review_schema.inc'); ?>
<?php endif; ?>
	...
	<div id="review_content" class="pb-4 bg-gray pt-4">
      ...
      <div class="row">
        <div class="col-md-9">
					<div class="bg-white shadow-sm mb-4 rounded over-hidden">
						<h4 class="align-middle background-main border-bottom d-block font-m text-uppercase text-white">
							<span class="align-middle background-complimentary d-inline-block icon-dice mr-2 p-1 text-white"></span> <?php print t('Available Games'); ?>
						</h4>
						<?php print render($page['content_c']); ?>
					</div>
					<div class="bg-white p-3 shadow-sm rounded over-hidden">
						<?php include_once('inc/review_main.inc'); ?>
					</div>
					<?php if(!$slim): ?>
					<div class="row">
        ...
        <div class="col-md-3 position-sticky sticky-top">
          <?php include_once('inc/review_side_top.inc'); ?>
        </div>
      </div>
		</div>
	</div>
